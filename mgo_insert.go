...
func main() {
	...
	// Optional. Swtich the session to a monotonic behavior
	// Reads may not be entirely up-to-date, but they will always seee the
	// history of changes moving forward, the data read will be consistent
	// across sequential queries in them same session, and modifications made
